...
publishing.repositories.maven {
    url = uri("https://repo.onepiece.software/snapshots")
    credentials {
        username = providers.environmentVariable("GRADLE_PUBLISH_KEY").orNull
        password = providers.environmentVariable("GRADLE_PUBLISH_SECRET").orNull
    }
}
